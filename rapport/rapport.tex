...
L'algorithme utilisant les flots afin de procéder à l'approche égalitariste et l'approche par regret sont vraiment proches. En particulier, la construction du graphe sera équivalente. En particulier il y a deux changements notoires :
\begin{itemize}
