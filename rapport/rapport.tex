...
\centerline{
\csvautotabular {csv/question_7/question_8_10.csv}
}
...
\centerline{
\csvautotabular {csv/question_16/question_16_15.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=15 }
\centerline{
\csvautotabular {csv/question_16/question_16_20.csv}
}
...
\caption{comparatif du modèle OWA et maxmin pour n=10 }
\centerline{
\csvautotabular {csv/question_16_bis/question_16_bis_15.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=15 }
\centerline{
\csvautotabular {csv/question_16_bis/question_16_bis_20.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=20 }
