...
\begin{table}
\centerline{
\csvautotabular {csv/question_15/data_100.csv}
}
...
\begin{table}
\centerline{
\csvautotabular {csv/question_16/res_5.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=5  }
\centerline{
\csvautotabular {csv/question_16/res_10.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=10 }
\centerline{
\csvautotabular {csv/question_16/res_15.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=15 }
\centerline{
\csvautotabular {csv/question_16/res_20.csv}
}
...
\begin{table}
\centerline{
\csvautotabular {csv/question_16_bis/res_5.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=5  }
\centerline{
\csvautotabular {csv/question_16_bis/res_10.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=10 }
\centerline{
\csvautotabular {csv/question_16_bis/res_15.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=15 }
\centerline{
\csvautotabular {csv/question_16_bis/res_20.csv}
}
\caption{comparatif du modèle OWA et maxmin pour n=20 }
